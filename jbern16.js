...
Elm.Jbern16.make = function (_elm) {
   ...
   var findSep = function (model) {
      return _U.eq(model.headline,"Contact Me:") ? A2($Html.span,_U.list([sepStyle]),_U.list([$Html.text(" ° ")])) : _U.eq(model.headline,
      "My Work:") ? A2($Html.span,_U.list([sepStyle]),_U.list([$Html.text(" ° ° ")])) : A2($Html.span,_U.list([sepStyle]),_U.list([$Html.text(" ° ° ° ")]));
   };
